...
//create the hash table
    ...
    public static void main (String[] args) throws IOException {
      File testFile = new File("C:/Users/Sony/Desktop/texts/dictionary.txt");     //this is where the file to be sorted is loaded from
...
//the whole thing is added together and then moduloed to create a hash table index
        ...
        //return (int)word.charAt(word.length()-1);
    	 int hashVal=0;//value for hash
    	 int pow26=1;//power
    	 for(int i=word.length()-1; i>=0; i--)//decreasing loop on length of word
    	 {
    		 int letter = word.charAt(i);   //get the char code of the string word
    		 hashVal += pow26 * letter;        //multiply it by 27
    		 pow26 *= 26;                      //next power of 27
    		 
    		 // can use horners expression which is hashVal * 27 + letter insted of last two lines of method but change loop to increase
    		 
    	 }
    	 return hashVal % (array.length+13); //return hash val mod the array length of prime 216569
      }
